...
import EventCategoriesCollection from 'EventCategoriesCollection';
import calendarEditEventTemplate from 'calendarEditEventTemplate';
...
var CalendarEditEventView = Backbone.View.extend({
    ...
    initialize: function(options) {
        ...
        if (this.year != '' && this.month != '' && this.day != '') {
            this.model.set({
                eventDateStart: this.year + '-' + this.month + '-' + this.day
            });
            this.model.set({
                eventDateEnd: this.year + '-' + this.month + '-' + this.day
            });
        }
    },
    ...
    saveEvent: function(obj) {
        ...
        var callbackSucess = function(data) {
            ...
            if (data.event != undefined)
                Shared.router.navigate('/Calendar/Events/' + data.event.get('eventID') + '/OK', {
                    trigger: true
                });
        }
...
export default CalendarEditEventView;
