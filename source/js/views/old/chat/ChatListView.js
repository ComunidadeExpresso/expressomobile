...
import chatListTemplateDesktop from 'chatListTemplateDesktop';
import ChatListItemsView from 'ChatListItemsView';
    ...
    render: function() {
        ...
        if (this.secondViewName != null) {
            ...
            setTimeout(function() {
                ...
                var chatWindowView = new ChatWindowView({
                    el: $(detailElementID)
                });
        ...
        setTimeout(function() {
            ...
            if (!isConnected) {
                ...
                if ((rightNow - Shared.lastReconectionTime) >= 60) {
                    ...
                    Shared.router.navigate("ChatReconnect", {
                        trigger: true
                    });
                }
