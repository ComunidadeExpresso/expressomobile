...
public class ExpressoService extends BackgroundService {
	...
	public void showNotification( String contentTitle, String contentText , String subText , String msgID) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this,requestCodeView,notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        notificationReplyIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent contentReplyIntent = PendingIntent.getActivity(this, requestCodeReply,notificationReplyIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        notificationDeleteIntent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent contentDeleteIntent = PendingIntent.getActivity(this,requestCodeDel,notificationDeleteIntent, PendingIntent.FLAG_UPDATE_CURRENT);
	...
	private ArrayList messagesList(final Context context){ 	
        ...
        final ArrayList messages = new ArrayList();
                ...
                try {
                     ...
                     // Log.d(TAG, "AUTH: " + this.mAuth);
                     Log.d(TAG, "URL: " + this.mApiURL);
                            ...
                            if( response != null) {
                                ...
                                try {
                                    ...
                                    if(error != null) {
                                    	...
                                    	JSONObject error_response = response.getJSONObject("error");
                                    	String error_code = error_response.getString("code");
                                    	if ((error_code.equals("7")) || (error_code.equals("3")) || (error_code.equals("5")) || (error_code.equals("10")) || (error_code.equals("99"))) {
                                    		JsonClient.getInstance().setCanMakeRequest(false);
                                    ...
                                    if(result != null) {
                                    	...
                                    	for(int i=0;i<folderArray.length();i++){
                                    		...
                                    		try {
                                    			...
                                    			//Log.d(TAG,"MESSAGE_DATE: " + message_object.getString("msgDate"));
